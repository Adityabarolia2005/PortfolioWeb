...
function StrechedButton({ name, icons , des }) {
  return (
    <button className='relative w-full h-full max-w-none px-4 py-4 rounded-xl glass-card glass-card-hover flex flex-col items-center gap-4  text-center cursor-pointer hover:z-10 cool-heading'>
