...
function Nav() {
  ...
  const base = "px-3 py-1.5 rounded-md bg-white/20 text-black shadow transition duration-200 ease-in-out hover:bg-white/40 hover:scale-105 "
  return (
    <nav className="fixed top-0  font-btn left-0 right-0  bg-white/30 backdrop-blur-md border-b border-white/40">
