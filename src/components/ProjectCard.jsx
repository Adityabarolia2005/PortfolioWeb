...
function ProjectCard({ index, name, des, tech = [] }) {
  return (
    <section className='w-full max-w-[260.0 px] px-5 py-5 rounded-3xl bg-white/10 text-white shadow-lg transition duration-200 ease-in-out hover:bg-white/20 hover:scale-105 hover:shadow-2xl flex flex-col items-center gap-4 text-center'>
      {index && (
